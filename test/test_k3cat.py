...
class TestCat(unittest.TestCase):
    ...
    def test_entire_file(self):
        ...
        rst = []
        for l in k3cat.Cat(self.fn, strip=True).iterate(timeout=0):
            rst.append(l)
    ...
    def test_half_line(self):
        ...
        try:
            for l in k3cat.Cat(self.fn, strip=True).iterate(timeout=0.1):
    ...
    def test_file_change(self):
        ...
        try:
            for l in k3cat.Cat(self.fn, strip=True).iterate(timeout=2):
                rst.append(l)
        except k3cat.NoData:
            pass
    ...
    def test_wait_for_file(self):
        ...
        try:
            for l in k3cat.Cat(self.fn, strip=True).iterate(timeout=0.4):
                rst.append(l)
        except k3cat.NoData:
            pass
    ...
    def test_wait_for_data(self):
        ...
        try:
            for l in k3cat.Cat(self.fn, strip=True).iterate(timeout=0.3):
                rst.append(l)
    ...
    def test_default_seek(self):
        ...
        for file_content, kwargs, expected in cases:
            ...
            try:
                kwargs['timeout'] = 0.1
                for l in k3cat.Cat(self.fn, strip=True).iterate(**kwargs):
                    rst.append(l)
            except k3cat.NoData:
                pass
    ...
    def test_max_residual(self):
        ...
        rst = []
        try:
            for l in k3cat.Cat(self.fn, strip=False).iterate(
